  ...
  return (
    <>
      <button
        ...
        className="flex h-9 min-w-0 flex-1 max-w-md items-center gap-2 overflow-hidden rounded-md border border-border bg-background px-3 text-sm text-muted-foreground transition-colors hover:bg-muted"
